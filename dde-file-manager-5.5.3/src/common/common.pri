unix {
    ...
    isEqual(ARCH, mips64) | isEqual(ARCH, mips32) | isEqual(ARCH, loongarch64) | isEqual(ARCH, riscv64) {
        DEFINES += SPLICE_CP
    ...
    isEqual(ARCH, sw_64) | isEqual(ARCH, mips64) | isEqual(ARCH, mips32) | isEqual(ARCH, loongarch64) | isEqual(ARCH, riscv64) {
